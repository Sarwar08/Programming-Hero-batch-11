...
const AddCoffee = () => {
    ...
    return (
        <div className='p-24 '>
            <div className='p-12 text-center space-y-4 bg-base-300'>
                ...
                <div>
                    <form onSubmit={handleAddCoffee}>
                        ...
                        <input type='submit' value='Add Coffee' className="btn w-full text-amber-500 text-xl btn-outline" />
                    </form>
                </div>
            </div>
        </div>
